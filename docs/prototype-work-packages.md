...
| WP2 | Relay conformance probe and routed-path measurement | WP0 | Deterministic part implemented and amended 2026-08-30 to the in-band session profile — public contract, browser probe, in-memory adapter and 157 deterministic tests; routed acceptance still pending operator-supplied runtime values and the integration UDP-echo provisioning |
